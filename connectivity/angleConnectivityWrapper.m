function angleConnectivityWrapper(freq, varargin)
...
%       connectivity measure compatible with phase data. Defaults to 'iplv'
% 
%  
...
% save file
saveF = [dirName, '/' , freq, '_angleConnectivity.mat'];
