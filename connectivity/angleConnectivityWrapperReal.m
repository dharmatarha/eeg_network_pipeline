function angleConnectivityWrapperReal(freq, varargin)

%% Calculate connectivity matrices based on real valued data
%
% USAGE: angleConnectivityWrapperReal(freq, dirName = pwd, subjects = {'s02', 's03', ...}, method = 'iplv')
%
...
% user message
disp([char(10), 'Starting angleConnectivityWrapperReal function with following arguments: ',...
