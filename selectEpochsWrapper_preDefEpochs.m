...
dirNameBase = '/home/peternagy/EEG_resting_state/';
load('/home/peternagy/NAS502/EEG_resting_state/theta/selectedEpochsSelectedSubjects.mat', 'epochIndicesConstraint', 'subjectIDs');
for freqBandIndex = 1 : numberOfFrequencyBands
    for connMetricIndex = 1 : numberOfConnMetrics
        ...
        dirName = [dirNameBase freqBandString '_varEpochLength'];
