...
for i = 1:length(fieldn)
    ...
    heatmap(xdata(omegaLim(1):omegaLim(2)), ydata(gammaLim(1):gammaLim(2)), diffRes.(fieldn{i})(gammaLim(1):gammaLim(2), omegaLim(1):omegaLim(2)), 'Title', [fieldn{i}, ' - ', titles{i}], 'XLabel', 'omega', 'Ylabel', 'gamma');
...
for i = 1:length(fieldn)
    ...
    f = figure;
    f.Position = [0 0 1800, 1080];
    heatmap(xdata(omegaLim(1):omegaLim(2)), ydata(gammaLim(1):gammaLim(2)), nullRes.res.(fieldn{i})(gammaLim(1):gammaLim(2), omegaLim(1):omegaLim(2)), 'Title', [fieldn{i}, ' - ', titles{i}], 'XLabel', 'omega', 'Ylabel', 'gamma');
