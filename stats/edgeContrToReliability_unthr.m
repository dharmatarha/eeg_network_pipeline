...
for freqBandIndex = 1 : numberOfFrequencyBands
    for connMetricIndex = 1 : numberOfConnMetrics
        ...
        subjectAveragedConnArray = squeeze(mean(subjectAveragedConnArray, 1));
        ...
        mainFig = circleGraphPlot_edges_mod(connMatrix, subjectAveragedConnArray, edgeMembership, colorTriplets,...
